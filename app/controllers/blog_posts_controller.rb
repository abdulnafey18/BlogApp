  ...
  def serialized_post(decorated_post)
    {
      ...
      created_at: decorated_post.instance_variable_get(:@blog_post).created_at&.strftime("%B %d, %Y, %I:%M %p"),
      updated_at: decorated_post.instance_variable_get(:@blog_post).updated_at&.strftime("%B %d, %Y, %I:%M %p")
    }
  end
